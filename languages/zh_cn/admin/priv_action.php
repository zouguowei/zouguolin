...
//商品管理部分的权限
$_LANG['goods_manage'] = '案例添加/编辑';
$_LANG['remove_back'] = '案例删除/恢复';
$_LANG['cat_manage'] = '分类添加/编辑';
$_LANG['cat_drop'] = '分类转移/删除';
$_LANG['attr_manage'] = '案例属性管理';
$_LANG['brand_manage'] = '案例品牌管理';
$_LANG['comment_priv'] = '用户评论管理';
$_LANG['goods_type'] = '案例类型';
$_LANG['tag_manage'] = '标签管理';
$_LANG['goods_auto'] = '案例自动上下架';
$_LANG['topic_manage'] = '专题管理';
$_LANG['virualcard'] = '虚拟卡管理';
$_LANG['picture_batch'] = '图片批量处理';
$_LANG['goods_export'] = '案例批量导出';
$_LANG['goods_batch'] = '案例批量上传/修改';
$_LANG['gen_goods_script'] = '生成案例代码';
$_LANG['suppliers_goods'] = '供货商案例管理';
