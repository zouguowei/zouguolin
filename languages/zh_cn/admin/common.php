...
$_LANG['app_name'] = '威生活';
$_LANG['cp_home'] = '威生活 管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2005-'. date('Y') .' 威生活，并保留所有权利。';
...
/* 商品管理 */
$_LANG['01_goods_list'] = '案例列表';
$_LANG['02_goods_add'] = '添加新案例';
$_LANG['03_category_list'] = '案例分类';
$_LANG['04_category_add'] = '添加分类';
$_LANG['05_comment_manage'] = '用户评论';
$_LANG['06_goods_brand_list'] = '案例品牌';
$_LANG['07_brand_add'] = '添加品牌';
$_LANG['08_goods_type'] = '案例类型';
$_LANG['09_attribute_list'] = '案例属性';
$_LANG['10_attribute_add'] = '添加属性';
$_LANG['11_goods_trash'] = '案例回收站';
$_LANG['12_batch_pic'] = '图片批量处理';
$_LANG['13_batch_add'] = '案例批量上传';
$_LANG['15_batch_edit'] = '案例批量修改';
$_LANG['16_goods_script'] = '生成案例代码';
$_LANG['17_tag_manage'] = '标签管理';
$_LANG['18_product_list'] = '货品列表';
$_LANG['52_attribute_add'] = '编辑属性';
$_LANG['53_suppliers_goods'] = '供货商案例管理';

$_LANG['14_goods_export'] = '案例批量导出';

$_LANG['50_virtual_card_list'] = '虚拟商品列表';
$_LANG['51_virtual_card_add'] = '添加虚拟商品';
$_LANG['52_virtual_card_change'] = '更改加密串';
$_LANG['goods_auto'] = '案例自动上下架';
