...
<div id="header-div">
  ...
  <div id="submenu-div">
    <ul>
      ...
      <li><a href="../" target="_blank"><img src="images/topmune_06.png" style="border:none;"/><span>查看网站</span></a></li>
      ...
      <li><a href="index.php?act=first" target="main-frame"><img src="images/topmune_01.png" style="border:none;"/><span><?php echo $this->_var['lang']['shop_guide']; ?></span></a></li>
    </ul>
...
<div id="menu-div">
  <ul>
    ...
    <li><a href="goods.php?act=list" target="main-frame"><img src="images/index-11_09.png" width="17" height="18" align="absmiddle"/><span>案例管理</span><span class="num"><?php echo $this->_var['goods_sum']; ?></span></a><span class="muneFG"></span></li>
